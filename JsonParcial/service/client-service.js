...
const API_URL_BOLETOS = "http://localhost:3000/boletos";

// Listar clientes (join local robusto con boletos)
const listaClientes = async () => {
  ...
  return clientes.map(cliente => ({
    ...
    boleto: boletos.find(b =>
      (b.id_bo !== undefined && Number(cliente.id_bo) === Number(b.id_bo)) ||
      (b.id !== undefined && Number(cliente.id_bo) === Number(b.id))
    ) || {}
  }));
};
